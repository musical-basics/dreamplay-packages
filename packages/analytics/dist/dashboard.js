...
function VisitorsTab({ selectedVisitor, setSelectedVisitor, visitors, history, historyLoading, backLabel, emailMode = false, }) {
    if (selectedVisitor) {
        return (_jsxs("section", { className: "dpa-panel dpa-panel-flush", children: [_jsxs("div", { className: "dpa-detail-header", children: [_jsxs("button", { type: "button", className: "dpa-back", onClick: () => setSelectedVisitor(null), children: [_jsx(ArrowLeft, { size: 16 }), backLabel] }), _jsx("span", { className: "dpa-divider" }), _jsxs("div", { className: "dpa-detail-id", children: [_jsx(Network, { size: 16 }), _jsx("span", { children: selectedVisitor.ip }), selectedVisitor.email && _jsx("span", { className: "dpa-email-pill", children: selectedVisitor.email }), _jsx(ClassificationBadge, { result: history?.classification ?? selectedVisitor.classification })] })] }), historyLoading ? (_jsxs("div", { className: "dpa-loading dpa-loading-inner", children: [_jsx(Loader2, { className: "dpa-spin", size: 20 }), " Loading visitor history..."] })) : history ? (_jsxs(_Fragment, { children: [_jsxs("div", { className: "dpa-detail-grid", children: [_jsx(DetailCard, { title: "Total Pageviews", value: history.total_pageviews }), _jsx(DetailCard, { title: "Pages Visited", value: new Set(history.visits.map((visit) => visit.path)).size }), _jsx(DetailCard, { title: "Total Time on Site", value: formatDuration(history.visits.reduce((sum, visit) => sum + (visit.duration_seconds ?? 0), 0) || null), highlight: true }), _jsx(DetailCard, { title: "First Seen", value: formatDate(history.first_seen) }), _jsx(DetailCard, { title: "Last Seen", value: formatDate(history.last_seen) }), _jsx(DetailCard, { title: "Location", value: formatLocation(history.geo?.city, history.geo?.region, history.geo?.country) }), _jsx(DetailCard, { title: "Source", value: _jsx(CopyableSource, { source: selectedVisitor.source ?? "Direct" }) }), _jsx(DetailCard, { title: "Journey", value: selectedVisitor.journey_id ?? "-" })] }), _jsx(VisitHistoryTable, { visits: history.visits })] })) : (_jsx("div", { className: "dpa-empty", children: "No visitor history found." }))] }));
    }
    return (_jsxs("section", { className: "dpa-panel dpa-panel-flush", children: [_jsxs("div", { className: "dpa-table-header", children: [_jsxs("h2", { children: [_jsx(Network, { size: 16 }), " ", emailMode ? "Email Visitors" : "Recent Visitors"] }), _jsxs("span", { children: [visitors.length.toLocaleString(), " visitors"] })] }), _jsx("div", { className: "dpa-table-wrap", children: _jsxs("table", { className: "dpa-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Last Seen" }), _jsx("th", { children: emailMode ? "Email / Attribution" : "Visitor" }), _jsx("th", { children: "Classification" }), _jsx("th", { children: "Variant" }), _jsx("th", { children: "Source" }), _jsx("th", { children: "Country" }), _jsx("th", { children: "Device" }), _jsx("th", { children: "Page Hits" }), _jsx("th", { children: "Time" }), _jsx("th", { children: "Last Page" })] }) }), _jsxs("tbody", { children: [visitors.map((visitor) => (_jsxs("tr", { onClick: () => setSelectedVisitor(visitor), children: [_jsx("td", { children: formatDate(visitor.lastSeen) }), _jsx("td", { children: _jsxs("div", { className: "dpa-visitor-cell", children: [_jsx("span", { children: visitor.email ?? visitor.sid ?? visitor.ip }), visitor.email && _jsx("small", { children: visitor.ip })] }) }), _jsx("td", { children: _jsx(ClassificationBadge, { result: visitor.classification }) }), _jsx("td", { children: visitor.variant ? _jsx("span", { className: "dpa-class", children: visitor.variant.toUpperCase() }) : _jsx("span", { className: "dpa-muted", children: "-" }) }), _jsx("td", { children: _jsx(CopyableSource, { source: visitor.source ?? "Direct" }) }), _jsx("td", { children: _jsxs("span", { className: "dpa-country", children: [_jsx(Globe, { size: 12 }), " ", visitor.country] }) }), _jsx("td", { children: _jsx(DeviceBadge, { device: visitor.device }) }), _jsx("td", { children: _jsx("span", { className: "dpa-count", children: visitor.count }) }), _jsx("td", { children: formatDuration(visitor.totalTimeSeconds || null) }), _jsx("td", { className: "dpa-path", title: visitor.lastPath, children: visitor.lastPath })] }, visitor.visitorKey))), visitors.length === 0 && (_jsx("tr", { children: _jsx("td", { colSpan: 10, className: "dpa-empty-cell", children: "No visitor data available." }) }))] })] }) })] }));
}
function CopyableSource({ source }) {
    const [copied, setCopied] = useState(false);
    if (!source || source === "Direct" || source === "-") {
        return _jsx("span", { className: "dpa-muted", children: source ?? "-" });
    }
    const handleCopy = (e) => {
        e.stopPropagation();
    ...
    return (_jsx("span", { className: "dpa-source", style: {
            cursor: "pointer",
            whiteSpace: "nowrap",
        ...
        }, title: `${source}\n\nClick to copy full values`, onClick: handleCopy, children: copied ? "COPIED!" : source }));
}
